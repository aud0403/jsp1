...
//참고 : hobby는 배열입니다. -> getParamterValues() 메소드로 데이터를 받습니다. -> 변수 타입은 String[]
		...
		//1)추가된 회원정보만 확인하기. 요청전달
		request.setAttribute("cus", cus);
		pageContext.forward("registration_view.jsp");
		
		//2)사용자가 요청하지 않았지만 회원리스트 list.jsp로 요청 바꾸기. registration.jsp 에서 list.jsp로 변경.
		//response.sendRedirect("list.jsp");	//응답을 보낼때 요청될 url 또는 파일을 저장합니다.
%>
